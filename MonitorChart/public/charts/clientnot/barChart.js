...
// Função para calcular as somas e criar o gráfico apenas para a Cliente_nao_Identificado
    ...
    const myChart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Comparação entre Tocadas e Espera (Totais) - Cliente_nao_Identificado'
                }
            }
        }
    });

...
// Função para calcular as somas e criar o gráfico apenas para a VIP
async function createChart() {
    ...
    async function updateChart() {
        ...
        const VIPData = data.filter(obj => obj.csqname === 'VIP');
    ...
    const myChart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Comparação entre Tocadas e Espera (Totais) - VIP'
                }
            }
        }
    });
